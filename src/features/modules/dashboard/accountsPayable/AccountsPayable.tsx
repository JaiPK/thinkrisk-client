...
const AccountsPayable = () => {
    ...
    const currentTab = () => {
        ...
        if (loc[loc.length -1] == "insights") return 0;
            ...
            return 2;
        else if (loc[loc.length -1] == "duplicate-invoices") return 3;
        else return 0;
    };
    ...
    const handleNavigateToTransDetails = (
        ...
        dispatch(updateAPTransDetailsDrillThrough(true));
        dispatch(
            updateAPTransDetailsDrillThroughConfig({
                transId: transId,
                document: document,
        ...
        navigate(`transactions/transaction-details/${document.ENTRY_ID}`);
    };
    ...
    return (
        <div className="flex flex-col w-full">
                        ...
                        return (
                            <Link
                                ...
                                className={`px-16 font-raleway text-sm no-underline text-black  border-x-0 border-t-0 border-b-2 p-2 cursor-pointer hover:border-gray-300 ${
                                    route.routeId === activeTab
                                        ? "border-solid border-sky-500"
                                        : ""
                                }`}
                            >
                                {route.tabTitle}
            ...
            <Routes>
                ...
                />
                <Route path="charts" element={<Charts highlightActiveTab={highlightActiveTab} />}></Route>
