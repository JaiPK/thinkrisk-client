...
const POST_CLOSE_DEVIATION_URL = "v1/ap/closedeviation";
          ...
          <Box sx={{ flexDirection: "column" }}>
            ...
            {title !== "Close Issue" ? (
              <Box sx={{ mt: "20px" }}>
                <FormControl>
                  <RadioGroup
                    id="close-task-ap-row-radio-buttons-group"
                    row
                    aria-labelledby="close-task-ap-row-radio-buttons-group-label"
                    name="close-task-ap-row-radio-buttons-group"
                    // defaultValue="1"
                    value={value}
