...
import { updateAccounts } from "../../../features/modules/gl-slice/GLSlice";
...
const GlAuditConfiguration: React.FC<ConfigurationProps> = forwardRef(
  ({ auditId, clientId }, ref) => {
    ...
    const [anomalyTrendChartValue, setAnomalyTrendChartValue] =
      React.useState("");
    ...
    const [documentTrendChartValue, setDocumentTrendChartValue] =
      React.useState("");
    const [documentTrendChartFlag, setDocumentTrendChartFlag] =
      React.useState(0);
    ...
    const [
      totalSelectedFightUsersCheckboxes,
      setTotalSelectedFightUsersCheckboxes,
    ] = React.useState(0);
    ...
    const [manualJournalUpdateStatus, setManualJournalUpdateStatus] =
      useState<any>();
    ...
    const getConfigData = async () => {
      ...
      for (let i = 0; i < updateModuleConfig.length; i++) {
        ...
        if (updateModuleConfig[i].KEYNAME === "Manual_Journal_Entries") {
          updateModuleConfig[i].STATUS = manualJournalUpdateStatus
            ? manualJournalUpdateStatus
    ...
    const getConfigModule = async () => {
      try {
        if (auditId) {
          ...
          let result = dataRecord.filter((dataRecord: { KEYNAME: any }) =>
            String(dataRecord.KEYNAME).startsWith("WEIGHT_")
          );
          ...
          for (let i = 0; i < dataRecord.length; i++) {
            ...
            if (dataRecord[i].KEYNAME === "LATE_NIGHT_POSTING") {
              ...
              const newStartTime = new Date(
                ...
                6,
                4,
                Number(JSON.parse(dataRecord[i].KEYVALUE).start),
                0,
                0,
                0
              );
              const newEndTime = new Date(
                ...
                6,
                4,
                Number(JSON.parse(dataRecord[i].KEYVALUE).end),
                0,
                0,
                0
              );
    ...
    const fightUserCheckBoxDetails = (
      index: any,
      userId: React.Key | null | undefined,
      checked: any
    ) => {
      ...
      if (checked == true) {
        setTotalSelectedFightUsersCheckboxes(
          totalSelectedFightUsersCheckboxes + 1
        );
      }
      if (checked == false) {
        setTotalSelectedFightUsersCheckboxes(
    ...
    const removeAccountCode = (item: any) => {
      ...
      if (item.subitems) {
        item.subitems = item.subitems.filter(
          (subitem: { ACCOUNT_CODE: string; title: string }) => {
    ...
    const fetchAccountCode = (item: any, name: any) => {
      ...
      item.subitems = item.subitems.filter((subitem: any) => {
        if (subitem.ACCOUNT_CODE) {
          ...
          setAccountCode((prev: any) => [
            ...prev,
            { code: subitem.ACCOUNT_CODE, title: subitem.title },
          ]);
    ...
    const isMatchedNode = (value: any, node: any) => {
      ...
      const isNOU = (value: any) => value === null || value === undefined;
      if (!isNOU(value)) {
    ...
    return (
      <>
        <div
          className="container mt-10 mx-2 w-auto"
          style={{
            fontSize: "16px",
            fontFamily: "Roboto",
            fontWeight: 400,
        ...
        >
          ...
          >
              ...
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Configure the users for system posted entries."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
              ...
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Configure the weights for each control point under GL."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
            ...
            <Tab
              style={{
                display: assignWeights?.[5].STATUS === 1 ? "block" : "none",
              }}
              sx={{ alignItems: "start", textAlign: "start" }}
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Configure the users for fire fighter rule."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
              ...
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Journal Entries posted during the weekends."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
              ...
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Journal Entries posted after regular business hours."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
          ...
          {...a11yProps(9)} /> */}
              ...
              label={
                <>
                  <div>
                    10. Holidays
                    <Tooltip
                      title="Journal Entries posted during a calendar holiday."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
              ...
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Day difference between the posted and posting date is greater than 12 and the posting is not done in the same quarter."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
            ...
            <Tab
              style={{
                display: assignWeights?.[36].STATUS === 1 ? "block" : "none",
              }}
              sx={{ alignItems: "start", textAlign: "start" }}
              label={
                <>
                  <div>
                    12. Rounding OFF
                    <Tooltip
                      title="Identify transactions with unusual identified number patterns."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
            ...
            <Tab
              style={{
                display: assignWeights?.[1].STATUS === 1 ? "block" : "none",
              }}
              sx={{ alignItems: "start", textAlign: "start" }}
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Journal entries posted by a person in non-finance department. E.g.: IT."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
            ...
            <Tab
              style={{
                display: assignWeights?.[29].STATUS === 1 ? "block" : "none",
              }}
              sx={{ alignItems: "start", textAlign: "start" }}
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Input any suspicious key words that require your attention appearing in the Transaction Text or Account description."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
            ...
            <Tab
              style={{
                display: assignWeights?.[8].STATUS === 1 ? "block" : "none",
              }}
              sx={{ alignItems: "start", textAlign: "start" }}
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Cash Negative Balance Period."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
              ...
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="In consideration of Journal Entries with Cash Concentration account credited, the corresponding debit account does not fall under Cash Disbursement, Cash Payroll and Cash Negative Balances."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
              ...
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Journal Entries with Cash Disbursement account in credit side are considered. If their corresponding debit account does not have an GL expense accounts."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
              ...
              label={
                <>
                  <div>
                    ...
                    <Tooltip
                      title="Journal Entries with Cash Payroll account in debit side are considered. If their corresponding credit account does not fall under Cash Concentration."
                      placement="top"
                    >
                      <InfoIcon style={{ fontSize: "16px", color: "#1976d2" }} />
                    </Tooltip>
            ...
            <FormGroup>
              {glDashboardChart?.map((data: any, index: any) => {
                return (
                  <FormControlLabel
                    key={index}
                    control={<Checkbox checked={data.status === true} />}
                    label={data.name}
                    onChange={(event) => glDasCheckbox(event, index)}
                  />
                );
              })}
            </FormGroup>
                    ...
                    <TableRow>
                      ...
                      >
                        <Button
                          ...
                          onClick={() => clearAllAutoPostingUser()}
                        >
                          Clear All
                        </Button>
                      </TableCell>
                      ...
                      return (
                        ...
                        >
                          <TableCell component="th" scope="row">
                            <Checkbox
                              checked={userIsChecked?.[index] == true}
                              onChange={(e) =>
                                userCheckBoxDetails(
                                  index,
                                  user.FMSUSERID,
          ...
          <TabPanel value={value} index={6}>
            <TableContainer component={Paper} style={{ maxHeight: 250 }}>
              ...
              >
                ...
                <TableBody>
                  {getFireFighterUser?.map(
                    (
                      user: {
                        FMSUSERID: React.Key | null | undefined;
                        FMSUSER_CODE:
                        | string
                        | number
                        | boolean
                      ...
                      >
                        <TableCell component="th" scope="row">
                          <Checkbox
                            checked={FightUerIsChecked?.[index] == true}
                            onChange={(e) =>
                              fightUserCheckBoxDetails(
                                index,
                                user.FMSUSERID,
                                e.target.checked
                              )
        ...
        <Stack mt={4} alignItems="flex-end" justifyContent="flex-end" direction={{ xs: 'column', sm: 'row' }} spacing={{ xs: 1, sm: 2, md: 4 }} >
                    ...
                    <Typography key={index}>
                      <div className="flex flex-wrap justify-center gap-x-2 gap-y-2">
                        ...
                        <p style={{ marginTop: "6vh" }}>
                          <Checkbox onClick={() => handleRange(itm, index)} />{" "}
                          Range{" "}
                        </p>
                        <p style={{ marginTop: "6vh" }}>
                          <Button>
                            <DeleteIcon
                              style={{ color: "gray" }}
                              fontSize="medium"
                              onClick={() => handleDelete(itm, index)}
                            />
                          </Button>{" "}
                        </p>
                      </div>
          ...
          <TabPanel value={value} index={11}>
            <Tags
              getRoundOffData={getRoundOffData}
              handleRound={handleRound}
              setGetRoundOffData={setGetRoundOffData}
              name="round"
            />
            <Stack
              mt={4}
          ...
          <TabPanel value={value} index={15}>
                  ...
                  <TableContainer component={Paper} style={{ maxHeight: 200 }}>
                    ...
                    >
                      ...
                      <TableBody sx={{ display: "flex", maxHeight: "24vh" }}>
                        <TableRow>
                          <TableCell
                            style={{ maxHeight: "2vh", maxWidth: "25vw" }}
                          >
                            {/* <MaskedTextBoxComponent
                              change={searchNodes.bind(this)}
                            /> */}
                            {/* <TreeViewComponent
                              fields={fields}
                              ref={(treeview) => {
                              ...
                              showCheckBox={true}
                              nodeChecked={(e) =>
                                nodeChecked(e, (name = "cashConcern"))
                              }
                            /> */}
                          </TableCell>
                          <TableCell>
            ...
            <Accordion style={{ maxWidth: "65vw" }}>
              ...
              >
                <Typography>
                  List of Accounts Expected on the credit side
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                          ...
                          <TableCell>
                            {cashCredit
                              ...
                              .map((itm: any, index: any) => (
                                <TableRow key={index}>{itm}</TableRow>
                              ))}
                            {accountCode.map((itm: any, index: any) => (
                              <TableRow key={index}>
                                {isShowCode ? (
            ...
            <Accordion style={{ maxWidth: "65vw" }}>
              ...
              >
                <Typography>
                  List of Accounts Expected on the debit side
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                        ...
                        <TableRow>
                          <TableCell>
                            {/* <TreeViewComponent
                              ...
                              showCheckBox={true}
                              nodeChecked={(e) =>
                                nodeChecked(e, (name = "cashDisbursment"))
                              }
                            /> */}
                          </TableCell>
                          <TableCell
                            ...
                            style={{ maxHeight: "10vh", overflow: "auto" }}
                          >
                            <TableRow>{cashDisbursment}</TableRow>
                            {accountCode.map((itm: any, index: any) => (
                              <TableRow key={index}>
                                {isShowCode ? (
                                  <p style={{ fontWeight: "bold" }}>
                        ...
                        <TableRow>
                          <TableCell>
                            {/* <TreeViewComponent
                              ...
                              showCheckBox={true}
                              nodeChecked={(e) =>
                                nodeChecked(e, (name = "cashPayrole"))
                              }
                            /> */}
                          </TableCell>
                          <TableCell
...
export default GlAuditConfiguration;
