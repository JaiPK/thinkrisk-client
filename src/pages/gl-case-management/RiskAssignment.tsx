...
const RiskAssignment = ({ data, reviewStatus }: Props) => {
    ...
    const DOC_COMMENTS = `/v1/je/accdoccomment/${documentKey}`;
    const ADD_COMMENT = "v1/je/accdoccomment";
    const DELETE_COMMENT = "/v1/je/accdoccomment/";

    const [selectedCommentId, setSelectedCommentId] = useState(0);
    const handleCommentsClick = (event: any) => {
        setCommentPopUpAnchorEl(event.currentTarget);
    };
    ...
    const commentsOpen = Boolean(commentPopUpAnchorEl);

    const handleChange = (event: SelectChangeEvent) => {
        setAge(event.target.value as string);
    };
    const HandleMainTableRowClick = (event: any) => {
    };
    const apiFilters = () => {};
            ...
            <div className="flex-row">
                <FormControl fullWidth variant="standard">
                    ...
                    <div className="flex-row absolute w-full left-1/2">
                        ...
                        <div className="flex-row absolute left-[15%] w-3/6 pt-[14px]">
                            <Select
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        component="th" scope="row">
                                            {riskData.ACCOUNTDOC_CODE}
                                        </TableCell>
                                        <TableCell
                                            align="right"
                                            sx={{ fontSize: 12 }}
                                        >
                                            {riskData.COMPANY_CODE_NAME}
                                        </TableCell>
